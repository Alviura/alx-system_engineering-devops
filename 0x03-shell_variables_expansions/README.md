File 0-alias creates an alias ls.
...
File 14-decimal_to_hexadecimal converts a number from base 10 to base 16.

File 100-rot13 encodes and decodes text using the rot13 encryption.

File 101-odd prints every other line from the input, starting with the first line.

File 102-water_and_stir adds the two numbers stored in the environment variables WATER and STIR and prints the result.
